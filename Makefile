...
obj_clean: 
	...
	instchk.o insthier.o mk-ctxt mk-ctxt.o vec_add.o vec_addsc.o \
	vec_align.o vec_angle.o vec_anglen.o vec_assi.o vec_degree.o \
	vec_degreen.o vec_dist.o vec_div.o vec_divsc.o vec_dotp.o vec_mag.o \
	vec_math.o vec_mult.o vec_multsc.o 
