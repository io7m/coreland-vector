...
static inline float *
vec_divNf_sse_gte16(float *va, const float *vb, unsigned int ne)
{
  __m128 mva1;
  __m128 mva2;
  __m128 mva3;
  ...
  for (ind = 0; ind < n16; ++ind) {
    ...
    mva3 = _mm_div_ps(mva3, mvb3);
    mvb4 = _mm_load_ps(pvb); pvb += 4;
    mva4 = _mm_div_ps(mva4, mvb4);
  ...
  if (nr) vec_divNf_sse_lt16(pva, pvb, nr);
  return va;
}

static inline float *
vec_divNf_sse(float *va, const float *vb, unsigned int ne)
{
  return (ne >= 16) ? vec_divNf_sse_gte16(va, vb, ne)
                    : vec_divNf_sse_lt16(va, vb, ne);
}

static inline float *
vec_divNfx_sse_lt16(const float *va, const float *vb, float *vr, unsigned int ne)
{
  __m128 mva1;
  __m128 mvb1;
  const float *pva;
...
static inline float *
vec_divNfx_sse_gte16(const float *va, const float *vb, float *vr, unsigned int ne)
{
  __m128 mva1;
  __m128 mva2;
  __m128 mva3;
  ...
  if (nr) vec_divNfx_sse_lt16(pva, pvb, pvr, nr);
  return vr;
}

static inline float *
vec_divNfx_sse(const float *va, const float *vb, float *vr, unsigned int ne)
{
