...
obj_clean: 
	...
	vec_add.o vec_addsc.o vec_align.o vec_angle.o vec_anglen.o \
	vec_assi.o vec_degree.o vec_degreen.o vec_dist.o vec_div.o \
	vec_divsc.o vec_dotp.o vec_mag.o vec_math.o vec_mult.o 
	rm -f vec_multsc.o vec_nega.o vec_norm.o vec_simd.o vec_sub.o \
