...
obj_clean: 
	...
	v_add_alti.o v_add_sse.o v_add_sse2.o v_addsc.o v_addsc_alti.o \
	v_addsc_sse.o v_addsc_sse2.o v_align.o 
	rm -f v_angle.o v_anglen.o v_assi.o v_assi_alti.o v_assi_sse.o \
